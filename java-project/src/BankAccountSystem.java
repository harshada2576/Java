...
public class BankAccountSystem {
    public static void main(String[] args) {
        ...
        SavingsAccount savingsAccount = new SavingsAccount(savingsNumber, savingsHolder,
                savingsBalance);
        ...
        CurrentAccount currentAccount = new CurrentAccount(currentNumber,
                currentHolder, currentBalance);
